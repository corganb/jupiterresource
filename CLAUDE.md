# JupiterResource - Claude Code Guide

## Site
- URL: https://jupiterresource.net
- Repo: https://github.com/corganb/jupiterresource
...
- Cloudflare Pages project name: `jupiterresource-site`
...
## Jupiter quirks
- Spacecraft present in scene: Juno, Galileo, Voyager 1/2, Cassini flyby, Europa Clipper, JUICE
...
```
wrangler pages deploy public --project-name=jupiterresource-site --branch=main
```
